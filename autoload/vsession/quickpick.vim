...
"    :QuickpickEmbed path=autoload/vsession/quickpick.vim namespace=vsession#quickpick prefix=vsession-quickpick
...
function! vsession#quickpick#open(opt) abort
  call vsession#quickpick#close() " hide existing picker if exists
  ...
  let s:state = extend({
      ...
      \ 'busy': 0,
      \ 'busyframes': ['-', '\', '|', '/'],
      \ 'filetype': 'vsession-quickpick',
      \ 'promptfiletype': 'vsession-quickpick-filter',
      \ 'input': '',
      \ 'maxheight': 10,
      \ 'debounce': 250,
      \ 'filter': 1,
  ...
  " map keys
  inoremap <buffer><silent> <Plug>(vsession-quickpick-accept) <ESC>:<C-u>call <SID>on_accept()<CR>
  nnoremap <buffer><silent> <Plug>(vsession-quickpick-accept) :<C-u>call <SID>on_accept()<CR>

  inoremap <buffer><silent> <Plug>(vsession-quickpick-close) <ESC>:<C-u>call vsession#quickpick#close()<CR>
  nnoremap <buffer><silent> <Plug>(vsession-quickpick-close) :<C-u>call vsession#quickpick#close()<CR>

  inoremap <buffer><silent> <Plug>(vsession-quickpick-cancel) <ESC>:<C-u>call <SID>on_cancel()<CR>
  nnoremap <buffer><silent> <Plug>(vsession-quickpick-cancel) :<C-u>call <SID>on_cancel()<CR>

  inoremap <buffer><silent> <Plug>(vsession-quickpick-move-next) <C-o>:<C-u>call <SID>on_move_next()<CR>
  nnoremap <buffer><silent> <Plug>(vsession-quickpick-move-next) :<C-u>call <SID>on_move_next()<CR>

  inoremap <buffer><silent> <Plug>(vsession-quickpick-move-previous) <C-o>:<C-u>call <SID>on_move_previous()<CR>
  nnoremap <buffer><silent> <Plug>(vsession-quickpick-move-previous) :<C-u>call <SID>on_move_previous()<CR>

  exec printf('setlocal filetype=' . s:state['promptfiletype'])

  if !hasmapto('<Plug>(vsession-quickpick-accept)')
    imap <buffer><cr> <Plug>(vsession-quickpick-accept)
    nmap <buffer><cr> <Plug>(vsession-quickpick-accept)
  endif

  if !hasmapto('<Plug>(vsession-quickpick-cancel)')
    imap <silent> <buffer> <C-c> <Plug>(vsession-quickpick-cancel)
    map  <silent> <buffer> <C-c> <Plug>(vsession-quickpick-cancel)
    imap <silent> <buffer> <Esc> <Plug>(vsession-quickpick-cancel)
    map  <silent> <buffer> <Esc> <Plug>(vsession-quickpick-cancel)
  endif

  if !hasmapto('<Plug>(vsession-quickpick-move-next)')
    imap <silent> <buffer> <C-n> <Plug>(vsession-quickpick-move-next)
    nmap <silent> <buffer> <C-n> <Plug>(vsession-quickpick-move-next)
    imap <silent> <buffer> <C-j> <Plug>(vsession-quickpick-move-next)
    nmap <silent> <buffer> <C-j> <Plug>(vsession-quickpick-move-next)
  endif

  if !hasmapto('<Plug>(vsession-quickpick-move-previous)')
    imap <silent> <buffer> <C-p> <Plug>(vsession-quickpick-move-previous)
    nmap <silent> <buffer> <C-p> <Plug>(vsession-quickpick-move-previous)
    imap <silent> <buffer> <C-k> <Plug>(vsession-quickpick-move-previous)
    nmap <silent> <buffer> <C-k> <Plug>(vsession-quickpick-move-previous)
  endif

  call cursor(line('$'), 0)
  call feedkeys('i', 'n')

  augroup vsession#quickpick
    autocmd!
  ...
  call vsession#quickpick#busy(s:state['busy'])
endfunction
...
function! vsession#quickpick#close() abort
  if !exists('s:state')
    return
  endif

  call vsession#quickpick#busy(0)
...
function! vsession#quickpick#items(items) abort
...
function! vsession#quickpick#busy(busy) abort
...
function! vsession#quickpick#results_winid() abort
  if exists('s:state')
